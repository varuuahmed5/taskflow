...
style={{
          background: "linear-gradient(135deg, hsl(252 85% 60%), hsl(220 80% 55%), hsl(190 90% 50%))",
        }}>
      ...
      <div className="relative flex w-full items-center justify-center bg-[#fafafa] px-6 lg:w-1/2">
        ...
        <div className="relative z-10 w-full max-w-md rounded-2xl bg-white p-8 shadow-xl shadow-black/5 lg:p-10">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <Button
              type="submit"
              className="mt-2 flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-primary text-sm font-semibold text-white transition-all hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[#4f8ef7]/50 focus:ring-offset-2"
            >
              Create Account
